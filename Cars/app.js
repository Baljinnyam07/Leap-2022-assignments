          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-end gap-3">
                <button type="button" id = "deleteBtn" class= "btn btn-success" onclick="updateCar(${car.id})">Засах</button>
...
const sumbitBtn = document.querySelector('#formSubmit');
...
const deleteCar =  (id) =>{
    if(confirm('Та устгахдаа итгэлтай байна уу?')){
...
const updateCar = (id) =>{
    // const updateCar = {
    // };
     fetch("http://localhost:3333/api/cars/" +id ).then(res=> res.json()).then(data => {imageUrlTarget.value = data.imageUrl})
